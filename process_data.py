...
def normalize(series, reverse=False):
    """Normalize a pandas series to 0–1. Reverse=True flips scale."""
...
def generate_polygons(df, props, box_size=0.005):
    """Convert each point into a small square polygon with given properties."""
    features = []
...
def main():
    try:
        ...
        flood_geojson = generate_polygons(
            df,
            {
                "city": "ID",
        ...
        landuse_geojson = generate_polygons(
            df,
            {
                "city": "ID",
